...
class Trainer(object):
    def __init__(self, data_config):
        ...
        # self.decoder = Decoder(self.n_users, self.n_items, self.emb_dim, self.weight_size, self.mess_dropout, self.image_feats, self.text_feats, self.user_init_embedding, self.item_attribute_embedding)
