...
def LLM_request(toy_augmented_item_attribute, indices, model_type, augmented_atttribute_embedding_dict, error_cnt, key, file_name):
    ...
    # try:
    #     augmented_atttribute_embedding_dict = file_reading()
    # except pickle.UnpicklingError as e:
    #     # Handle the unpickling error
    #     # time.sleep(0.001)
    #     # augmented_atttribute_embedding_dict = file_reading()
    #     # print("Error occurred while unpickling:", e) 
    #     LLM_request(toy_augmented_item_attribute, indices, "text-embedding-ada-002", augmented_atttribute_embedding_dict, error_cnt, key)
    #     print("Error occurred while unpickling:", e) 
    ...
    for value in augmented_atttribute_embedding_dict.keys():
        if indices[0] in augmented_atttribute_embedding_dict[value]:
            ...
            try: 
                ...
                # ### baidu #############################################################################################################################
                # url = "http://llms-se.baidu-int.com:8200/embeddings"
                # headers={
                #     # "Content-Type": "application/json",
                #     # "Authorization": "Bearer "
...
# for i in range(0, toy_augmented_item_attribute.shape[0], 1):
#     batch_start = i
#     batch_end = min(i + 1, toy_augmented_item_attribute.shape[0])
#     indices = list(range(batch_start, batch_end))
#     # print(f"###i###: {i}")
#     print(f"#######: {indices}")
#     LLM_request(toy_augmented_item_attribute, indices, "text-embedding-ada-002", augmented_atttribute_embedding_dict, error_cnt, g_key)
...
#     # print(f"###i###: {i}")
#     print(f"#######: {indices}")
#     LLM_request(toy_augmented_item_attribute, indices, "text-embedding-ada-002", augmented_atttribute_embedding_dict, error_cnt, "sk---wangqinyong---UB0ts8gBEuai/PVCYRzaWQ==")
...
#     # print(f"###i###: {i}")
#     print(f"#######: {indices}")
#     LLM_request(toy_augmented_item_attribute, indices, "text-embedding-ada-002", augmented_atttribute_embedding_dict, error_cnt, "sk---sulixin---LarRDv0I9h543KWXfVO3ZQ==")

# for i in range(4500, 6000, 1):
#     batch_start = i
#     batch_end = min(i + 1, toy_augmented_item_attribute.shape[0])
#     indices = list(range(batch_start, batch_end))
#     # print(f"###i###: {i}")
#     print(f"#######: {indices}")
#     LLM_request(toy_augmented_item_attribute, indices, "text-embedding-ada-002", augmented_atttribute_embedding_dict, error_cnt, "sk---yuyongjia---NE7Dr1/Bn/l2nXue+lYjqA==")
...
#     # print(f"###i###: {i}")
#     print(f"#######: {indices}")
#     LLM_request(toy_augmented_item_attribute, indices, "text-embedding-ada-002", augmented_atttribute_embedding_dict, error_cnt, "sk---chenlijuan---AZPQ57TxibqPTeJCK/shVA==")
...
#     # print(f"###i###: {i}")
#     print(f"#######: {indices}")
#     LLM_request(toy_augmented_item_attribute, indices, "text-embedding-ada-002", augmented_atttribute_embedding_dict, error_cnt, "sk---qianjin03---CvVLLhmzDFTxpeRn7fLnaQ==")

# for i in range(9000, toy_augmented_item_attribute.shape[0], 1):
#     batch_start = i
#     batch_end = min(i + 1, toy_augmented_item_attribute.shape[0])
#     indices = list(range(batch_start, batch_end))
#     # print(f"###i###: {i}")
#     print(f"#######: {indices}")
#     LLM_request(toy_augmented_item_attribute, indices, "text-embedding-ada-002", augmented_atttribute_embedding_dict, error_cnt, "sk---tanghengzhu---B91jO0ghjXcY5hddgTJB2Q==")
