...
# csv_file_path = "/home/weiw/Code/LLMs/data/preprocessed_raw_MovieLens/toy_item_attribute.csv"
...
### read item_attribute
# toy_item_attribute = pd.read_csv('/Users/weiwei/Documents/Datasets/ml-10m/ml-10M100K/preprocessed_raw_MovieLens/toy_MovieLens1000/toy_item_attribute.csv', names=['id','title', 'genre'])
...
# if os.path.exists("/Users/weiwei/Documents/Datasets/ml-10m/ml-10M100K/preprocessed_raw_MovieLens/toy_MovieLens1000/augmented_user_profiling_dict"): 
if os.path.exists(file_path + "augmented_user_profiling_dict"): 
    print(f"The file augmented_user_profiling_dict exists.")
    # augmented_user_profiling_dict = pickle.load(open('/Users/weiwei/Documents/Datasets/ml-10m/ml-10M100K/preprocessed_raw_MovieLens/toy_MovieLens1000/augmented_user_profiling_dict','rb')) 
    augmented_user_profiling_dict = pickle.load(open(file_path + 'augmented_user_profiling_dict','rb')) 
else:
    print(f"The file augmented_user_profiling_dict does not exist.")
    # pickle.dump(augmented_user_profiling_dict, open('/Users/weiwei/Documents/Datasets/ml-10m/ml-10M100K/preprocessed_raw_MovieLens/toy_MovieLens1000/augmented_user_profiling_dict','wb'))
    pickle.dump(augmented_user_profiling_dict, open(file_path + 'augmented_user_profiling_dict','wb'))
